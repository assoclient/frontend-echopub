...
const menuItems = [
  { path: '/advertiser/dashboard', label: 'Tableau de bord', icon: 'DataBoard' },
  { path: '/advertiser/campaigns', label: 'Mes Campagnes', icon: 'Promotion' },
  { path: '/advertiser/campaigns/create', label: 'Nouvelle Campagne', icon: 'Plus' },
  { path: '/advertiser/profile', label: 'Mon Profil', icon: 'User' }
]

const currentPageTitle = computed(() => {
  const currentItem = menuItems.find(item => item.path === router.currentRoute.value.path)
  return currentItem?.label || 'Annonceur'
})
